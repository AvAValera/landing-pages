export default function MobileBtnMenu({ showMenu, setShowMenu, mode }) {
        ...
        <div>
            {!showMenu && (
                ...
                >
                    {mode === "lite" ? (
                        <>
                            <div className="header__mobile-btn_circle w-[13px] h-[13px] border-white border-[2px] rounded-full"></div>
                            <div className="header__mobile-btn_circle w-[13px] h-[13px] border-white border-[2px] rounded-full"></div>
                            <div className="header__mobile-btn_circle w-[13px] h-[13px] border-white border-[2px] rounded-full"></div>
                            <div className="header__mobile-btn_circle w-[13px] h-[13px] border-white border-[2px] rounded-full"></div>
                        </>
