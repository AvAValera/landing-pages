...
export default function Main() {
    ...
    return (
        <main className="main  overflow-hidden">
            <div ref={mainContainer} className="main__container ] bg-[url('/img/index/main/main-bg.png')] bg-no-repeat bg-[right_-1000%_bottom] bg-contain px-7 md:pl-[130px] mb-[80px] opacity-0">
