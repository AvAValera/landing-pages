    ...
    return (
        <Layout title="services">
            ...
            <div className="service__bottom-block px-[27px] lg:px-[129px] max-w-[1366px] mx-auto mb-[130px] flex flex-col lg:flex-row lg:justify-between gap-[35px]">
                <h2 className="text-[22px] text-main-color font-semibold">why you should choose us</h2>
                <div className="leading-[19px] max-w-[540px]">
                    <p>We provide full range of logistics related outsourcing services for Freight Forwarders, NVOCCs, Auto Dealers and other Exporters in International Freight Industry.</p><br/>
